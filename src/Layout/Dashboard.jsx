          ...
          <ul className="menu p-4 w-72">
            ...
            {isAdmin && (
              <>
                ...
                <li>
                  <NavLink to="/dashboard/managejewelry">
                    <FcManager /> Manage Jewelry
                  </NavLink>
                </li>
                <li>
            ...
            {isOwner && (
              <>
                ...
                <li>
                  <NavLink to="/dashboard/addjewelry">
                    <FaUtensils /> Add A Jewelry
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/dashboard/myjewelry">
                    <SiGoogleclassroom /> My Jewelry
                  </NavLink>
                </li>
              </>
            )}
            {!isAdmin && !isOwner && (
              <>
                <li>
                  <NavLink to="/dashboard/clienthome">
                    <FaHome /> Client Home
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/dashboard/selectedjewelry">
                    <FaFirstOrderAlt /> Selected Jewelry
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/dashboard/jewelry">
                    <SiGoogleclassroom /> Jewelry
                  </NavLink>
                </li>
              </>
            )}
